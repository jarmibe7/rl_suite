...
class ConvVAE(nn.Module):
  def __init__(self, latent_size, in_channels, conv_params, device):
    ...
    self.conv_encoder = ConvEncoder(self.latent_size, in_channels, conv_params)
    ...
    self.conv_decoder = ConvDecoder(
        self.latent_size, 
        conv_params, 
        self.conv_encoder.out_dim_flat, 
        self.conv_encoder.out_shape
    )
    self.out_image_shape = self.conv_decoder.out_image_shape
